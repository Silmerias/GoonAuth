...
<form class="form-register" role="form" action="{{ URL::action('RegisterController@postReapply') }}" method="post">
	...
	<p>Use the same GoonID as you used the first time you tried to apply.</p>
	...
	<input type="text" name="goonid" class="form-control" placeholder="GoonID" required="" autofocus="" onblur="validate(this)" data-type="goonid">
