...
<form class="form-register" role="form" action="{{ URL::to(Request::path().'/link') }}" method="post">
	...
	<div class="col-md-12">
		<p>Go <a href="{{ $game->GEditProfileURL }}" target="_blank">edit your game profile</a> and place the token below in any of the public fields. Once you've done that, enter your username and click the Request button.</p>
